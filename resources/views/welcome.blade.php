...
@section('konten')
        ...
        <section class="jumbotron text-center">
            <img src="/image/bola.jpg" alt="" width="200" height="" class="rounded-circle img-thumbnail">
            <h1 class="display-4">Triaji Pangestu Luhur</h1>
            <p class="lead">12 RPL 1 | Absen 38</p>
        </section>
